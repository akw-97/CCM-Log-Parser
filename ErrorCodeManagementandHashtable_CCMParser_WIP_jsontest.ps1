...
$errorCodeDescriptions = @{
    ...
    "0x87D00280" = "The content distribution failed because the distribution point is not accessible"
    "0x87D00281" = "The content distribution failed because the distribution point does not have sufficient disk space"
    "0x87D00282" = "The content distribution failed because the distribution point is offline"
    "0x87D00283" = "The content distribution failed because the distribution point is not responding"
    "0x87D00284" = "The content distribution failed because the distribution point certificate is invalid"
...
# converts hashtable to JSON
$json = $errorCodeDescriptions | ConvertTo-Json -Depth 2

# outputs the JSON
Write-Output $json

# Save the JSON to a file
$json | Out-File -FilePath "C:\Users\t8918704\OneDrive - OneMain Financial\Documents\Scripts\CCM Log Parser\ErrorCodesandDescriptions1.json" -Encoding UTF8